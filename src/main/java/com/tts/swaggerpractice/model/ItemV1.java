...
//response model
//@Data can be added after you add your lombok dependencies in the build.gradle if you wish to use it
//has to be above the public class item and you need to add the imports
public class ItemV1 {
